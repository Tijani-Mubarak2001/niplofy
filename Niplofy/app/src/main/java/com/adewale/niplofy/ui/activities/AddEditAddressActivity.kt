...
class AddEditAddressActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (mAddressDetails != null){
            if (mAddressDetails!!.id.isNotEmpty()){
                tv_edit_title.text = resources.getString(R.string.title_edit_address)
                ...
                et_email_add.setText(mAddressDetails?.email)
    ...
    private fun saveAddressToFirestore() {
        ...
        val email: String = et_email_add.text.toString().trim { it <= ' ' }
    ...
    private fun validateData(): Boolean {
        return when {
            ...
            TextUtils.isEmpty(et_email_add.text.toString().trim { it <= ' ' }) -> {
                showErrorSnackBar(
                    resources.getString(R.string.err_msg_please_enter_email),
                    true
                )
                false
            }
